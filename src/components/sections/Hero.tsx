      ...
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
        <div className="w-[41%] max-md:w-full max-md:ml-0">
          <div className="flex w-full flex-col self-stretch text-white font-medium my-auto max-md:max-w-full max-md:mt-10">
            ...
            <p className="text-[#828282] text-lg mt-[9px]">Frontend Developer</p>
            <div className="flex items-stretch gap-2.5 text-sm mt-[35px]">
              <button className="bg-[#27AE60] px-[27px] py-3 max-md:px-5 hover:bg-[#219652] transition-colors">
                Download CV
              </button>
        ...
        <div className="w-[59%] ml-5 max-md:w-full max-md:ml-0">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/a020a9884d4afea31034bb44bb77423df9c6c71f?placeholderIfAbsent=true"
            alt="Hero image"
